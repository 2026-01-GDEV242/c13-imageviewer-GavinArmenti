 ...
 * The top right image is the image tinted red.
 * The bottom left image is the image tinted green.
 * The bottom right image is the image tinted blue.
 * 
    ...
    public void apply(OFImage image)
    {
        ...
        for(int y = 0; y < height; y++) {
            ...
            for(int x = 0; x < width; x++) {
                ...
                image.setPixel(x+width, y, new Color(red,green,blue));
            }
        }
        ...
        for(int y = 0; y < height; y++) {
            ...
            for(int x = 0; x < width; x++) {
                ...
                image.setPixel(x, y+height, new Color(red,green,blue));
            }
            // blue image
            for(int x = 0; x < width; x++) {
